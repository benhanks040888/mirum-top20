  ...
  <div class="section">
    <div class="container">
      <div class="columns is-variable is-6">
        <div class="column">
          <div class="level">
            <div class="level-left">
              <div>
                <h2 class="title is-3">{{ $username }}'s Top 20</h2>
                <h3 class="subtitle is-6 has-text-grey">(Last update at {{ $user_chart[0]->created_at->format('d M Y H:i:s') }})</h3>
              </div>
            </div>
          </div>
        ...
        <div class="column is-narrow">
          @include('_partials.sidebar', ['items' => $votes_users])
        </div>
      </div>
    </div>
  </div>
